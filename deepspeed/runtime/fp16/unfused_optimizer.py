...
class FP16_UnfusedOptimizer(object):
    ...
    def step_fused_lamb(self, closure=None, block_eigenvalue={}):
        """
    ...
    def step(self, closure=None, block_eigenvalue={}):
        """
        Not supporting closure.
        """

        if self.fused_lamb_legacy:
            return self.step_fused_lamb(block_eigenvalue=block_eigenvalue)
